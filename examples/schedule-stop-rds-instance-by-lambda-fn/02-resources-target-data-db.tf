...
resource "aws_db_subnet_group" "tgt_data_db_subnet_grp" {
  name = "${var.sys_name}-tgt-data-db-subnet-grp"
...
resource "aws_db_instance" "tgt_data_dbi" {
  identifier            = "${var.sys_name}-tgt-data-dbi"
  ...
  db_subnet_group_name                = aws_db_subnet_group.tgt_data_db_subnet_grp.name
